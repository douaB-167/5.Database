...
-- il tipo TEXT NON ha bisogno di dimensione
-- modify `desciption` text default null;
...
where `code` = ' PRD00001';
-- ATTENZIONE
-- where `code` = ' PRD00001'; ha uno spazio
-- se osservi l'output noterai: 0 row(s) affected Rows matched: 0  Changed: 0  Warnings: 0
